...
function calculateScope() {
  ...
  if (squadContainer) {
    ...
    if (activeIds.includes('iot')) {
      squadContainer.innerHTML += '<span class="pill pill-blue">IoT & Embedded Systems Team</span> ';
    }
    ...
    if (activeIds.includes('seo')) {
      squadContainer.innerHTML += '<span class="pill pill-blue">Technical SEO & Growth Team</span> ';
    }
